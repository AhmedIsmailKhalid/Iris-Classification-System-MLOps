...
class TestModelTraining:
    ...
    def test_load_model(self, training_data):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Load model
            model, loaded_preprocessor, metadata = IrisModelTrainer.load_model(model_path)
